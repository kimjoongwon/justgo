...
import DetailFavoriteContainer from "../containers/DetailFavoriteContainer";
  ...
  render() {
    ...
    return (
      <BrowserRouter>
        ...
        <Route exact path="/favoriteposts" component={FavoritePageContainer} />
        <Route path="/favoriteposts/:id" component={DetailFavoriteContainer} />
